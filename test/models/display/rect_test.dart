...
void main() {
  group('Rect', () {
    test('fromDartRect converts ui.Rect correctly', () {
      ...
      final rect = Rect.fromDartRect(dartRect);
    ...
    test('handles edge cases', () {
      // Zero rect
      final zeroRect = Rect.fromDartRect(ui.Rect.zero);
      expect(zeroRect.toProtobufInstance().left, 0.0);

      // Negative values
      final negRect = Rect(-10, -20, -5, -10);
      expect(negRect.toProtobufInstance().left, -10.0);
    });
  });
}
