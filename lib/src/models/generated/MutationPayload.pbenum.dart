...
class DisplayCommandType extends $pb.ProtobufEnum {
  ...
  static const DisplayCommandType DrawViewContentEndAnnotation =
      DisplayCommandType._(30, _omitEnumNames ? '' : 'DrawViewContentEndAnnotation');
  static const DisplayCommandType DrawViewContentStartAnnotation =
      DisplayCommandType._(31, _omitEnumNames ? '' : 'DrawViewContentStartAnnotation');
  static const DisplayCommandType FillViewCommandsAnnotation =
      DisplayCommandType._(32, _omitEnumNames ? '' : 'FillViewCommandsAnnotation');
  ...
  static DisplayCommandType? valueOf($core.int value) => value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class ShaderType extends $pb.ProtobufEnum {
  ...
  static ShaderType? valueOf($core.int value) => value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PathVerbType extends $pb.ProtobufEnum {
  ...
  static PathVerbType? valueOf($core.int value) => value < 0 || value >= _byValue.length ? null : _byValue[value];
