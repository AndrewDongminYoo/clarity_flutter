...
class BoxConstraints implements IProtoModel<mutation_payload.BoxConstraints> {
  ...
  BoxConstraints.fromDartBoxConstraints(rendering.BoxConstraints constraints)
    : this(
        constraints.minWidth.isInfinite ? double.maxFinite : constraints.minWidth,
        constraints.maxWidth.isInfinite ? double.maxFinite : constraints.maxWidth,
        constraints.minHeight.isInfinite ? double.maxFinite : constraints.minHeight,
        constraints.maxHeight.isInfinite ? double.maxFinite : constraints.maxHeight,
      );
  double minWidth;
