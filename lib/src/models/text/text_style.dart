...
class TextStyle implements IProtoModel<mutation_payload.TextStyle> {
  ...
  factory TextStyle.fromDartTextStyle(rendering.TextStyle textStyle) {
    return TextStyle(
      textStyle.inherit,
      textStyle.color == null ? null : Color4f.fromDartColor(textStyle.color!),
      textStyle.backgroundColor == null ? null : Color4f.fromDartColor(textStyle.backgroundColor!),
      textStyle.fontSize,
      textStyle.fontWeight == null ? null : FontWeight.fromDartFontWeight(textStyle.fontWeight!),
      ...
      textStyle.locale == null ? null : Locale.fromDartLocale(textStyle.locale!),
      textStyle.foreground == null ? null : Paint.fromDartPaint(textStyle.foreground!),
      textStyle.background == null ? null : Paint.fromDartPaint(textStyle.background!),
      textStyle.decoration == null ? null : TextDecoration.fromDartTextDecoration(textStyle.decoration!),
      textStyle.decorationColor == null ? null : Color4f.fromDartColor(textStyle.decorationColor!),
...
class FontWeight implements IProtoModel<mutation_payload.FontWeight> {
  FontWeight(this.value) : index = (value ~/ 100 - 1).clamp(0, 8);

  FontWeight.fromDartFontWeight(rendering.FontWeight fontWeight) : this(fontWeight.value);
  int index;
  int value;

  @override
  mutation_payload.FontWeight toProtobufInstance() {
    return mutation_payload.FontWeight(index: index, value: value);
  }
}
...
class Locale implements IProtoModel<mutation_payload.Locale> {
  ...
  Locale.fromDartLocale(rendering.Locale locale) : this(locale.languageCode, locale.countryCode);
  String languageCode;
  String? countryCode;

  @override
  mutation_payload.Locale toProtobufInstance() {
    return mutation_payload.Locale(languageCode: languageCode, countryCode: countryCode);
  }
}
...
class TextDecoration implements IProtoModel<mutation_payload.TextDecoration> {
  ...
  static TextDecoration? fromDartTextDecoration(ui.TextDecoration textDecoration) {
    var mask = 0;
  ...
  mutation_payload.TextDecoration toProtobufInstance() {
    return mutation_payload.TextDecoration(mask: mask);
  }
}
