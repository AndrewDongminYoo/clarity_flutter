...
class HttpUtils {
  ...
  }) => _executeHttpRequest('GET', uri, headers: headers, retryPolicy: retryPolicy);
  ...
  static Future<HttpClientResponse> post(
    ...
    List<int>? data,
    RetryPolicy<HttpClientResponse>? retryPolicy,
  }) => _executeHttpRequest('POST', uri, headers: headers, data: data, retryPolicy: retryPolicy);

  static Future<HttpClientResponse> _executeHttpRequest(
    String method,
    Uri uri, {
    Map<String, String> headers = const {},
    List<int>? data,
    ...
    return _withClient((client) async {
      ...
      final request = await _openHttpConnection(client, method, uri, headers: headers);
  ...
  static Future<HttpClientResponse> _getHttpResponse(HttpClientRequest request, List<int>? data) async {
  ...
  static Future<HttpClientResponse> _withClient(
    ...
    final client = HttpClient()
      ..connectionTimeout = const Duration(milliseconds: ClarityConstants.connectionTimeoutInMs);
    try {
      if (retryPolicy != null) {
        return await retryPolicy.tryAsync(() async => fn(client));
      }
